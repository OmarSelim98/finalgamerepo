...
public class SinglePlayerGame extends Game {
    ...
    public SinglePlayerGame(ChoosePlayerMenu menu,String difficulty){
        super(false,difficulty);
        ...
        root.getChildren().addAll(player1.imgView,player1.armView,healthbar1);
        gameLoop();
    }
}
